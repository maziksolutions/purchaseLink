...
export class JobTypeComponent implements OnInit {
  ...
  jobtypeForm: FormGroup; flag; pkey: number = 0;
  displayedColumns: string[] = ['checkbox', 'jobType','jsa','isPostpone'];
  ...
  get fm() { return this.jobtypeForm.controls };
  ...
  onSubmit() {
    ...
    formData.append('data', JSON.stringify(this.jobtypeForm.value));
  ...
  clear() {
    ...
    this.jobtypeForm.controls.jobTypeId.setValue(0);
